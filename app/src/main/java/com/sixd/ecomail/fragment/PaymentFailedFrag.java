...
import com.sixd.ecomail.adapter.PaymentFailedAdapter;
...
public class PaymentFailedFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_paymentfailed, null);
        all_documents.clear();
        all_documents= ((PaymentActivity)getActivity()).paymentFailed_doc;
    ...
    public void initViews(){
        recyleFailed=view.findViewById(R.id.recyleFailed);
        setFailedList();
    }

    SwipeController swipeController = null;
    PaymentFailedAdapter paymentFailedAdapter=null;
    public void setFailedList(){
        paymentFailedAdapter=new PaymentFailedAdapter(mContext,custom_inboxDataModels);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(mContext);
        recyleFailed.setLayoutManager(layoutManager);
        recyleFailed.setItemAnimator(new DefaultItemAnimator());
        recyleFailed.setAdapter(paymentFailedAdapter);

       /* SwipeAndDragHelper swipeAndDragHelper = new SwipeAndDragHelper(paymentFailedAdapter,paymentFailedAdapter,mContext);
        ItemTouchHelper touchHelper = new ItemTouchHelper(swipeAndDragHelper);
        paymentFailedAdapter.setTouchHelper(touchHelper);
        recyleFailed.setAdapter(paymentFailedAdapter);
        touchHelper.attachToRecyclerView(recyleFailed);*/
        ...
        itemTouchhelper.attachToRecyclerView(recyleFailed);

        recyleFailed.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                if (responce_Str.equals(Constant.SUCCESS_MSG)) {
                    ...
                    paymentFailedAdapter.notifyDataSetChanged();
