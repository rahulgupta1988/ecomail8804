...
import com.sixd.ecomail.adapter.PaymentDueAdapter;
...
public class PaymentDueFrag extends Fragment {
    View view;
    Context mContext;
    RecyclerView recyleDue;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_paymentdue, null);
        all_documents.clear();
        all_documents = ((PaymentActivity) getActivity()).paymentDue_doc;
    ...
    public void initViews() {
        recyleDue = view.findViewById(R.id.recyleDue);
        setDueList();
    }

    SwipeController swipeController = null;
    PaymentDueAdapter paymentDueAdapter = null;

    public void setDueList() {
        paymentDueAdapter = new PaymentDueAdapter(mContext, custom_inboxDataModels);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(mContext);
        recyleDue.setLayoutManager(layoutManager);
        recyleDue.setItemAnimator(new DefaultItemAnimator());
        recyleDue.setAdapter(paymentDueAdapter);
       /* SwipeAndDragHelper swipeAndDragHelper = new SwipeAndDragHelper(paymentDueAdapter,paymentDueAdapter,mContext);
        ItemTouchHelper touchHelper = new ItemTouchHelper(swipeAndDragHelper);
        paymentDueAdapter.setTouchHelper(touchHelper);
        recyleDue.setAdapter(paymentDueAdapter);
        touchHelper.attachToRecyclerView(recyleDue);*/
        ...
        itemTouchhelper.attachToRecyclerView(recyleDue);

        recyleDue.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                if (responce_Str.equals(Constant.SUCCESS_MSG)) {
                    ...
                    paymentDueAdapter.notifyDataSetChanged();
