...
public class PaymentScheduleFrag extends Fragment {
    View view;
    Context mContext;
    RecyclerView recyleSchedule;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_paymentschedule, null);
        all_documents.clear();
        all_documents = ((PaymentActivity) getActivity()).paymentScheduled_doc;
    ...
    public void initViews() {
        recyleSchedule = view.findViewById(R.id.recyleSchedule);
        setScheduleList();
    }

    SwipeController swipeController = null;
    PaymentScheduleAdapter paymentScheduleAdapter = null;

    public void setScheduleList() {
        paymentScheduleAdapter = new PaymentScheduleAdapter(mContext, custom_inboxDataModels);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(mContext);
        recyleSchedule.setLayoutManager(layoutManager);
        recyleSchedule.setItemAnimator(new DefaultItemAnimator());
        recyleSchedule.setAdapter(paymentScheduleAdapter);

      /*  SwipeAndDragHelper swipeAndDragHelper = new SwipeAndDragHelper(paymentScheduleAdapter,paymentScheduleAdapter,mContext);
        ItemTouchHelper touchHelper = new ItemTouchHelper(swipeAndDragHelper);
        paymentScheduleAdapter.setTouchHelper(touchHelper);
        recyleSchedule.setAdapter(paymentScheduleAdapter);
        touchHelper.attachToRecyclerView(recyleSchedule);*/
        ...
        itemTouchhelper.attachToRecyclerView(recyleSchedule);

        recyleSchedule.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
