...
public class PaymentDueAdapter extends RecyclerView.Adapter<PaymentDueAdapter.DueHolder> /*implements
    ...
    public PaymentDueAdapter(Context mContext, List<Custom_InboxDataModel> documents) {
    ...
    @Override
    public PaymentDueAdapter.DueHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.paymentdueitem, parent, false);
        return new PaymentDueAdapter.DueHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final PaymentDueAdapter.DueHolder holder, final int position) {
   ...
   /* @Override
    ...
    public class DueHolder extends RecyclerView.ViewHolder {
        ...
        public DueHolder(View itemView) {
            super(itemView);
