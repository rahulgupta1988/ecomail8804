...
public class PaymentPaidAdapter extends RecyclerView.Adapter<PaymentPaidAdapter.PaidHolder> /*implements
    ...
    public PaymentPaidAdapter(Context mContext, List<Custom_InboxDataModel> documents) {
    ...
    @Override
    public PaymentPaidAdapter.PaidHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.paymentspaiditem, parent, false);
        return new PaymentPaidAdapter.PaidHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final PaymentPaidAdapter.PaidHolder holder, final int position) {
