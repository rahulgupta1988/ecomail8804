 ...
 */
public class FolderDocsAdapter extends RecyclerView.Adapter<FolderDocsAdapter.InboxHolder> implements
    ...
    public FolderDocsAdapter(Context mContext, List<Custom_InboxDataModel> documents) {
    ...
    @Override
    public FolderDocsAdapter.InboxHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.folderdoclistitem, parent, false);
        return new FolderDocsAdapter.InboxHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final FolderDocsAdapter.InboxHolder holder, final int position) {
...
//        holder.txtFundingBank.setText("" + bankName);
  //      holder.txtCurrentBalance.setText(showPriceInUSD(currentBalance));
    ...
    public class InboxHolder extends RecyclerView.ViewHolder {
        ...
        TextView txt_actionMSGDispla,txtPreStatPay;
