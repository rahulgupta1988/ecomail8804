...
public class PaymentFailedAdapter extends RecyclerView.Adapter<PaymentFailedAdapter.FailedHolder> /*implements
    ...
    public PaymentFailedAdapter(Context mContext, List<Custom_InboxDataModel> documents) {
    ...
    @Override
    public PaymentFailedAdapter.FailedHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.paymentfaileditem, parent, false);
        return new PaymentFailedAdapter.FailedHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final PaymentFailedAdapter.FailedHolder holder, final int position) {
   ...
   /* @Override
    ...
    public class FailedHolder extends RecyclerView.ViewHolder {
        ...
        public FailedHolder(View itemView) {
            super(itemView);
