...
public class MySubsAdapter extends RecyclerView.Adapter<MySubsAdapter.MySubsHolder> {

    Context context;
    LayoutInflater layoutInflater;
    List<Subscription> mySubscriptionList = null;

    public MySubsAdapter(Context context, List<Subscription> mySubscriptionList) {
    ...
    @Override
    public MySubsAdapter.MySubsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.mysubsadapter_view, parent, false);
        return new MySubsAdapter.MySubsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MySubsAdapter.MySubsHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ExistSubsCriptionActivity)context).subscriptionDetailDialog(position);
            }
        });
